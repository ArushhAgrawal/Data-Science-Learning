...
optimizer= torch.optim.SGD(params= model_0.parameters(), lr=0.201)
...
#importing decision boudary using request lib 
if Path("helper.py").is_file():#just if else to make sure we dont download it again and again
    print("alredy downloaded")
else:
    print("downloading helper function")
    request_code= requests.get("https://raw.githubusercontent.com/mrdbourke/pytorch-deep-learning/main/helper_functions.py")#this a code written by Daniel Bourke in this he wrote some funtion which are gonna be usefull in here
    with open("helper.py", "wb") as file:#this gonna open the file to edit whats inside it and it also gonna open the requested item as a file 
        file.write(request_code.content)#to get the code into the helper.py file
#model may not be learning fixing it
